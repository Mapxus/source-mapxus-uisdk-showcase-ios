...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
  ...
  func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
    ...
    let nav = SampleNavigationController(rootViewController: vc)
...
extension SceneDelegate: MXMServiceDelegate {
  func registerMXMServiceSuccess() {
    print("register MXMService Success")
  }
  
  func registerMXMServiceFailWithError(_ error: Error) {
    print("register MXMService Fail")
  }
}
