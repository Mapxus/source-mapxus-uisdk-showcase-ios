...
final class MapBoundsRestrictionViewController: BaseFeatureViewController, UITextFieldDelegate {
    ...
    private enum BoundsValidationError: LocalizedError {
        ...
        var errorDescription: String? {
            switch self {
            case .missingFields:
                return "Please fill in all Bounds fields (maxLat, maxLon, minLat, minLon)."
    ...
    override func saveBarButtonTapped() {
        ...
        Config.shared.diConfig.mapBoundsRestriction = bounds
    ...
    private func validate() -> (error: Error?, bounds: Bounds?) {
        ...
        // Bounds selected -> validate & parse
    ...
    private func selectorRowView() -> UIView {
        ...
        let label = UILabel()
        label.text = "mapBoundsRestriction :"
