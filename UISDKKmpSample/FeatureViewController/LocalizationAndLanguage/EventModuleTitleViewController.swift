...
//  Default: nil
//  Description: Title displayed at the top of the event list on the event page.
...
final class EventModuleTitleViewController: BaseFeatureViewController {
    ...
    override func saveBarButtonTapped() {
        ...
        if segmentControl.selectedSegmentIndex == 0 {
            Config.shared.diConfig.eventModuleTitle = nil
            Config.shared.saveChange([featureName: nil as StringsWithLanguage?])
        } else if let strings = strings {
            Config.shared.diConfig.eventModuleTitle = strings
