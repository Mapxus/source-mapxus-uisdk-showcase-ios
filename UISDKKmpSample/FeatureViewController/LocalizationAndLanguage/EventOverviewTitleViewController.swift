...
//  Default: nil
//  Description: Title shown above the event overview section on the event detail page.
//  Supports multiple languages via [StringsWithLanguage].
//  When null, a default localized title will be shown.
//
...
final class EventOverviewTitleViewController: BaseFeatureViewController {
    ...
    override func saveBarButtonTapped() {
        ...
        if segmentControl.selectedSegmentIndex == 0 {
            Config.shared.diConfig.eventOverviewTitle = nil
            Config.shared.saveChange([featureName: nil as StringsWithLanguage?])
        } else if let strings = strings {
            Config.shared.diConfig.eventOverviewTitle = strings
