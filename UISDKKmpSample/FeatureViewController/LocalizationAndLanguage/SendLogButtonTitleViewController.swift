...
//  Default: nil
//  Description: Log title displayed on the menu page.
//  Supports multiple languages via [StringsWithLanguage].
//  If null, the log title will not be displayed.
//
...
final class SendLogButtonTitleViewController: BaseFeatureViewController {
    ...
    override func saveBarButtonTapped() {
        ...
        if segmentControl.selectedSegmentIndex == 0 {
            Config.shared.diConfig.sendLogButtonTitle = nil
            Config.shared.saveChange([featureName: nil as StringsWithLanguage?])
        } else if let strings = strings {
            Config.shared.diConfig.sendLogButtonTitle = strings
