...
//  Default: nil
//  Description: Custom display name for the close button in the Settings page.
//
...
final class CloseButtonTitleViewController: BaseFeatureViewController {
    ...
    override func saveBarButtonTapped() {
        ...
        if segmentControl.selectedSegmentIndex == 0 {
            Config.shared.diConfig.closeButtonTitle = nil
            Config.shared.saveChange([featureName: nil as StringsWithLanguage?])
        } else if let strings = strings {
            Config.shared.diConfig.closeButtonTitle = strings
