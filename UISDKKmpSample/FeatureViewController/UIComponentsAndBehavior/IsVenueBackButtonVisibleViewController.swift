...
//  Type: Boolean
//  Default: false
//  Description: Whether to display the venue back button on the venue page. This button allows users to navigate back from the venue context.
//
...
final class IsVenueBackButtonVisibleViewController: BaseFeatureViewController {
    ...
    override func saveBarButtonTapped() {
        ...
        Config.shared.diConfig.isVenueBackButtonVisible = value
    ...
    private func inputRowView() -> UIView {
        ...
        let label = UILabel()
        label.text = "isVenueBackButtonVisible :"
