...
//  Default: nil
//  Description: Title text for highlighted shops within the venue.
//  Supports multiple languages via [StringsWithLanguage].
//  Used to emphasize featured or promoted shops in the venue map UI.
//
...
final class VenueHighlightedShopTitleViewController: BaseFeatureViewController {
    ...
    override func saveBarButtonTapped() {
        ...
        if segmentControl.selectedSegmentIndex == 0 {
            Config.shared.diConfig.venueHighlightedShopTitle = nil
            Config.shared.saveChange([featureName: nil as StringsWithLanguage?])
        } else if let strings = strings {
            Config.shared.diConfig.venueHighlightedShopTitle = strings
    ...
    private func selectorRowView() -> UIView {
        ...
        let label = UILabel()
        label.text = "venueHighlightedShopTitle :"
