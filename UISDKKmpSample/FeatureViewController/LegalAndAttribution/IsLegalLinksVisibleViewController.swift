...
//  Type: Boolean
//  Default: true
//  Description: Determines whether the legal links section is visible in the UI.
//
...
final class IsLegalLinksVisibleViewController: BaseFeatureViewController {
    ...
    override func saveBarButtonTapped() {
        ...
        Config.shared.diConfig.isLegalLinksVisible = value
    ...
    private func inputRowView() -> UIView {
        ...
        let label = UILabel()
        label.text = "isLegalLinksVisible :"
