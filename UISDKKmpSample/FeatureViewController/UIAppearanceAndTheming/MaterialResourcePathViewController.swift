...
final class MaterialResourcePathViewController: BaseFeatureViewController {

    private let textField = UITextField()

    private enum MaterialPathValidationError: LocalizedError {
        case emptyPath
        var errorDescription: String? {
            switch self {
            case .emptyPath: return "Please enter a material resource path."
            }
        }
    }
    ...
    override func saveBarButtonTapped() {
        ...
        Config.shared.diConfig.materialResourcePath = value
    ...
    private func validate() -> (error: Error?, value: String) {
        ...
        guard !value.isEmpty else { return (MaterialPathValidationError.emptyPath, "") }
        return (nil, value)
    }
    ...
    private func inputRowView() -> UIView {
        ...
        let label = UILabel()
        label.text = "materialResourcePath :"
