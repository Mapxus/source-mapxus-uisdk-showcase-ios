...
//  Type: [String]?
//  Default: nil
//  Description: Categories of POIs permanently displayed on the map.
//  Used to highlight key categories such as restaurants, restrooms, etc.
//  Default is null, meaning no categories are fixed for display.
//
...
final class FixedDisplayCategoriesViewController: BaseFeatureViewController {
    ...
    override func viewDidLoad() {
        ...
        // Selector + input for fixedDisplayCategories
    ...
    override func saveBarButtonTapped() {
        ...
        Config.shared.diConfig.fixedDisplayCategories = categories
    ...
    private func selectorRowView() -> UIView {
        ...
        let label = UILabel()
        label.text = "fixedDisplayCategories :"
    ...
    private func categoriesInputFieldsView() -> UIView {
        ...
        hintLabel.text = "Multiple categories separated by commas, e.g. \"restaurant, restroom\"."
