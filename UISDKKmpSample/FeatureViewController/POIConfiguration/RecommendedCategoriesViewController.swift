...
//  Type: [String]?
//  Default: nil
//  Description: List of recommended POI categories to highlight or prioritize in the UI.
//  Can be used to guide users toward commonly used or featured categories.
//  Displayed in the categories section.
//  When null, the default category list is displayed.
//
...
final class RecommendedCategoriesViewController: BaseFeatureViewController {
    ...
    override func viewDidLoad() {
        ...
        // Selector + input for recommendedCategories
    ...
    override func saveBarButtonTapped() {
        ...
        Config.shared.diConfig.recommendedCategories = categories
    ...
    private func selectorRowView() -> UIView {
        ...
        let label = UILabel()
        label.text = "recommendedCategories :"
    ...
    private func categoriesInputFieldsView() -> UIView {
        ...
        hintLabel.text = "Recommended categories separated by commas, e.g. \"restaurant, restroom\". When null, the default category list is displayed."
