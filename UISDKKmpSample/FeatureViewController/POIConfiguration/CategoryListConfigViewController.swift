...
//  Type: [String]?
//  Default: nil
//  Description: List of categories displayed on the venue page.
//  Defines which categories are shown by default to the user.
//  When null, no categories will be displayed.
//
...
final class CategoryListConfigViewController: BaseFeatureViewController {
    ...
    override func viewDidLoad() {
        ...
        // Selector + input for categoryListConfig
    ...
    override func saveBarButtonTapped() {
        ...
        Config.shared.diConfig.categoryListConfig = categories
