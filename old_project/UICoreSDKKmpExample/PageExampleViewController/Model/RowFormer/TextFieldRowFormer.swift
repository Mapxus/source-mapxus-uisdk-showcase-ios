...
protocol TextFieldFormableRow: FormableRow {
    func formTextField() -> TipTextField
    func formTitleLabel() -> UILabel?
}

class TextFieldRowFormer<T: UITableViewCell>
: BaseRowFormer<T>, Formable where T: TextFieldFormableRow {
    ...
    @discardableResult
    public final func onTextEnd(_ handler: @escaping ((String) -> Void)) -> Self {
        onTextEnd = handler
        return self
    }
    ...
    @discardableResult
    public final func onTextBegin(_ handler: @escaping ((String) -> Void)) -> Self {
        onTextBegin = handler
        return self
    }
    ...
    private final var onTextEnd: ((String) -> Void)?
    private final var onTextBegin: ((String) -> Void)?
    private final var textColor: UIColor?
    private final var titleColor: UIColor?

    private lazy var observer = Observer<T>(textFieldRowFormer: self)
